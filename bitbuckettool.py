#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Get all your bitbucket respository at once-Fetches/Displays your bitbucket permissions
-                                                                          
usage :     
python bitbucket.py -u username -p password -o owner my_perm                                
-                                                                              
...
def my_perm(project=None, status='new'):
    """Displays all the respository assigned to you in a specific project if project
...
def execute_commands(commands):
    ...
    bitbucket -u username -p password show_my_perm:projectx
    """
